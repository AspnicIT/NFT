...
/***/ "./js/modules/functional/homePageBrowsersSection.js":
/*!**********************************************************!*\
  !*** ./js/modules/functional/homePageBrowsersSection.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function homePageBrowsersSection() {
  var themes = document.querySelectorAll('.category__grid_item');
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (homePageBrowsersSection);
...
/***/ "./js/modules/functional/tabsOnArtistPage.js":
/*!***************************************************!*\
  !*** ./js/modules/functional/tabsOnArtistPage.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (tabsOnArtistPage);
...
function insertFooter() {
  ...
  parentElement.append(footerContent);
}
...
/* harmony import */ var _modules_functional_homePageBrowsersSection__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/functional/homePageBrowsersSection */ "./js/modules/functional/homePageBrowsersSection.js");
...
/* harmony import */ var _modules_functional_tabsOnArtistPage__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/functional/tabsOnArtistPage */ "./js/modules/functional/tabsOnArtistPage.js");
/* harmony import */ var _modules_constructors_createWelcomeCollectionPage__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/constructors/createWelcomeCollectionPage */ "./js/modules/constructors/createWelcomeCollectionPage.js");
/* harmony import */ var _modules_constructors_createNftCards__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/constructors/createNftCards */ "./js/modules/constructors/createNftCards.js");
/* harmony import */ var _modules_functional_searchMarketplace__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./modules/functional/searchMarketplace */ "./js/modules/functional/searchMarketplace.js");
/* harmony import */ var _modules_functional_marketplaceTabs__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./modules/functional/marketplaceTabs */ "./js/modules/functional/marketplaceTabs.js");
/* harmony import */ var _modules_functional_topCreatorsTabs__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./modules/functional/topCreatorsTabs */ "./js/modules/functional/topCreatorsTabs.js");
/* harmony import */ var _modules_functional_timer__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./modules/functional/timer */ "./js/modules/functional/timer.js");
/* harmony import */ var _modules_dataBase_artistDB__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./modules/dataBase/artistDB */ "./js/modules/dataBase/artistDB.js");
/* harmony import */ var _modules_dataBase_nftDB__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./modules/dataBase/nftDB */ "./js/modules/dataBase/nftDB.js");
/* harmony import */ var _modules_dataBase_collectDb__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./modules/dataBase/collectDb */ "./js/modules/dataBase/collectDb.js");
/* harmony import */ var _modules_constructors_creatObjectOfCollections__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./modules/constructors/creatObjectOfCollections */ "./js/modules/constructors/creatObjectOfCollections.js");
...
function topAutors(artistId) {
  _modules_dataBase_nftDB__WEBPACK_IMPORTED_MODULE_21__.nftDBarr.forEach(function (item) {
    if (item.artist == artistId) {
      (0,_modules_constructors_createNftCards__WEBPACK_IMPORTED_MODULE_15__["default"])(item, '.artist__grid', '..');
    }
  });
}
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (body.classList.contains('home')) {
    ...
    (0,_modules_constructors_homePageWelcomeAdv__WEBPACK_IMPORTED_MODULE_5__["default"])(_modules_dataBase_nftDB__WEBPACK_IMPORTED_MODULE_21__.nftDBarr);
    (0,_modules_constructors_trendingCollections__WEBPACK_IMPORTED_MODULE_6__["default"])(_modules_dataBase_nftDB__WEBPACK_IMPORTED_MODULE_21__.trendCollectArr, '.trend__container', '.');
    (0,_modules_constructors_topCreatorsOnHomePage__WEBPACK_IMPORTED_MODULE_7__["default"])(_modules_dataBase_artistDB__WEBPACK_IMPORTED_MODULE_20__.artistsArr.slice(0, 12));
    ...
    (0,_modules_constructors_createNftCards__WEBPACK_IMPORTED_MODULE_15__["default"])(_modules_dataBase_nftDB__WEBPACK_IMPORTED_MODULE_21__.nft.happyRobot032, '.discover__grid', '.');
    (0,_modules_constructors_createNftCards__WEBPACK_IMPORTED_MODULE_15__["default"])(_modules_dataBase_nftDB__WEBPACK_IMPORTED_MODULE_21__.nft.dancingRobot56, '.discover__grid', '.');
    (0,_modules_constructors_createNftCards__WEBPACK_IMPORTED_MODULE_15__["default"])(_modules_dataBase_nftDB__WEBPACK_IMPORTED_MODULE_21__.nft.iceCreamApe, '.discover__grid', '.');
    ...
    (0,_modules_functional_timer__WEBPACK_IMPORTED_MODULE_19__["default"])('2023-06-22');
  }
  if (body.classList.contains('marketplace')) {
    ...
    _modules_dataBase_nftDB__WEBPACK_IMPORTED_MODULE_21__.nftDBarr.forEach(function (item) {
      return (0,_modules_constructors_createNftCards__WEBPACK_IMPORTED_MODULE_15__["default"])(item, '.artist__grid', '..');
    });
    ...
    (0,_modules_constructors_trendingCollections__WEBPACK_IMPORTED_MODULE_6__["default"])(_modules_constructors_creatObjectOfCollections__WEBPACK_IMPORTED_MODULE_23__.collectItemsArr, '.content__grid', '..');
    (0,_modules_functional_localStorage__WEBPACK_IMPORTED_MODULE_9__["default"])('./collection.html', '.miror', "collection");
    (0,_modules_functional_marketplaceTabs__WEBPACK_IMPORTED_MODULE_17__["default"])(_modules_dataBase_nftDB__WEBPACK_IMPORTED_MODULE_21__.nftDBarr, _modules_dataBase_collectDb__WEBPACK_IMPORTED_MODULE_22__.collectDbArr);
    (0,_modules_functional_searchMarketplace__WEBPACK_IMPORTED_MODULE_16__["default"])();
  }
  if (body.classList.contains('toplist')) {
    (0,_modules_innerHtml_header__WEBPACK_IMPORTED_MODULE_10__["default"])();
    (0,_modules_innerHtml_footer__WEBPACK_IMPORTED_MODULE_11__["default"])();
    (0,_modules_functional_topCreatorsTabs__WEBPACK_IMPORTED_MODULE_18__["default"])();
  }
  if (body.classList.contains('artistPage')) {
    ...
    (0,_modules_constructors_createArtistPage__WEBPACK_IMPORTED_MODULE_12__["default"])(_modules_dataBase_artistDB__WEBPACK_IMPORTED_MODULE_20__.artistsDB[artistId]);
    ...
    (0,_modules_functional_localStorage__WEBPACK_IMPORTED_MODULE_9__["default"])('./collection.html', '.mirrorFromCollection', "collection");
    (0,_modules_functional_tabsOnArtistPage__WEBPACK_IMPORTED_MODULE_13__["default"])();
  }
  if (body.classList.contains('collection')) {
    ...
    (0,_modules_constructors_createWelcomeCollectionPage__WEBPACK_IMPORTED_MODULE_14__["default"])(_modules_dataBase_collectDb__WEBPACK_IMPORTED_MODULE_22__.collectDbObj[collectionId]);
    _modules_dataBase_nftDB__WEBPACK_IMPORTED_MODULE_21__.nftDBarr.forEach(function (item) {
      if (item.collection == collectionId) {
        (0,_modules_constructors_createNftCards__WEBPACK_IMPORTED_MODULE_15__["default"])(item, '.content__grid', '..');
      }
    });
    (0,_modules_functional_localStorage__WEBPACK_IMPORTED_MODULE_9__["default"])('artist.html', '.mirrorFromAutor', "artist");
    (0,_modules_functional_localStorage__WEBPACK_IMPORTED_MODULE_9__["default"])('artist.html', '.creats__btn', "artist");
